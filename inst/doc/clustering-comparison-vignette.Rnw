...
<<init>>=
library(chopsticks)
load(system.file("data/Genotypes.GenTrain1.Rda",package="chopsticks"))
load(system.file("data/Genotypes.GenTrain2.Rda",package="chopsticks"))
@

Reading the raw cluster data in:

<<>>=
ab.signals <- read.wtccc.signals(system.file("data/example-new.txt", package="chopsticks"),
                                 paste("rs", 1:99, sep=""))
@
