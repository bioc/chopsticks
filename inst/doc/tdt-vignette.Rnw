...
pdftitle={TDT and chopsticks Vignette}]
{hyperref}

\title{TDT vignette\\Use of chopsticks in family--based studies}
...
The {\tt chopsticks} package contains some tools for analysis of
